...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        t1.goals_conceded = cmp::max(cmp::max(t1.goals_conceded, team_2_score), team_1_score);
        ...
        t2.goals_conceded = cmp::max(cmp::max(t2.goals_conceded, team_2_score), team_1_score);
